  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-8 bg-[#111]">
      <div className={cn(
        ...
        device === 'desktop' ? "w-full h-full max-h-full" : "w-[375px] h-[812px]"
      )}>
        <div className="p-4 border-b border-orange-500/10 flex justify-between items-center bg-[#0a0a0a]">
          ...
          <div className="flex bg-[#0f0f0f] border border-orange-900/20 rounded-md px-3 py-1 flex-1 max-w-[240px] justify-between items-center mx-4 gap-2">
            <span className="text-[10px] text-orange-500/60 font-mono tracking-widest uppercase truncate">localhost:3000</span>
          ...
          <div className="flex gap-1 justify-end min-w-[60px]">
            <button 
              ...
              className={cn("p-1.5 rounded transition-colors", device === 'desktop' ? "bg-orange-600/10 text-orange-500" : "text-zinc-600 hover:text-zinc-400")}
            >
              <Monitor size={14} />
            </button>
            <button 
              onClick={() => setDevice('mobile')}
              className={cn("p-1.5 rounded transition-colors", device === 'mobile' ? "bg-orange-600/10 text-orange-500" : "text-zinc-600 hover:text-zinc-400")}
            >
              <Smartphone size={14} />
            </button>
        ...
        <div className="flex-1 bg-[#050505] relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center space-y-4">
              ...
              <p className="text-[10px] text-zinc-500 tracking-widest uppercase font-mono">Building preview...</p>
            </div>
          </div>
        </div>
      </div>
