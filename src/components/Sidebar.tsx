        ...
        <div className="relative bg-orange-600/10 border border-orange-600/40 rounded-xl flex flex-col focus-within:border-orange-500 transition-colors">
          <div className="flex px-4 pt-3 flex-wrap gap-2">
            <div className="flex items-center gap-2 bg-zinc-900/80 border border-zinc-700/50 rounded-lg px-2 py-1.5">
              ...
              <span className="text-xs text-zinc-300">ScreenShot Tool -202606...</span>
              <button className="text-zinc-500 hover:text-zinc-300 ml-1"><Plus size={14} className="rotate-45"/></button>
            </div>
          </div>
          <textarea
            value={input}
          ...
          <div className="flex justify-between items-center px-3 pb-3">
            <div className="flex gap-2 text-orange-500/70">
              <button title="Upload Image" className="p-1.5 hover:bg-orange-500/10 rounded transition-colors hover:text-orange-400">
                <Plus size={16} />
              </button>
              <button title="Add Code" className="p-1.5 hover:bg-orange-500/10 rounded transition-colors hover:text-orange-400">
                <Sparkles size={16} />
              </button>
            </div>
